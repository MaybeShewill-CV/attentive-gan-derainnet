...
class GenerativeNet(cnn_basenet.CNNBaseModel):
        ...
        with tf.variable_scope(name):
            for i in range(5):
                if i == 0:
                    ...
                    relu_1 = self.lrelu(inputdata=bn_1, name='block_{:d}_relu_1'.format(i + 1))
                    output = relu_1
                    input_tensor = output
                else:
                    conv_1 = self.conv2d(inputdata=input_tensor,
                    ...
                    bn_1 = self.layerbn(inputdata=conv_1, is_training=self._is_training,
                                        name='block_{:d}_bn_1'.format(i + 1))
                    relu_1 = self.lrelu(inputdata=bn_1, name='block_{:d}_conv_1'.format(i + 1))
                    ...
                    relu_2 = self.lrelu(inputdata=bn_2, name='block_{:d}_conv_2'.format(i + 1))
    ...
    def build_autoencoder(self, input_tensor, name):
        ...
        with tf.variable_scope(name):
            ...
            bn_1 = self.layerbn(inputdata=conv_1, is_training=self._is_training,
                                name='bn_1')
            relu_1 = self.lrelu(inputdata=bn_1, name='relu_1')
            ...
            bn_2 = self.layerbn(inputdata=conv_2, is_training=self._is_training,
                                name='bn_2')
            relu_2 = self.lrelu(inputdata=bn_2, name='relu_2')
            ...
            bn_3 = self.layerbn(inputdata=conv_3, is_training=self._is_training,
                                name='bn_3')
            relu_3 = self.lrelu(inputdata=bn_3, name='relu_3')
            ...
            bn_4 = self.layerbn(inputdata=conv_4, is_training=self._is_training,
                                name='bn_4')
            relu_4 = self.lrelu(inputdata=bn_4, name='relu_4')
            ...
            bn_5 = self.layerbn(inputdata=conv_5, is_training=self._is_training,
                                name='bn_5')
            relu_5 = self.lrelu(inputdata=bn_5, name='relu_5')
            ...
            bn_6 = self.layerbn(inputdata=conv_6, is_training=self._is_training,
                                name='bn_6')
            relu_6 = self.lrelu(inputdata=bn_6, name='relu_6')
            ...
            bn_7 = self.layerbn(inputdata=dia_conv1, is_training=self._is_training,
                                name='bn_7')
            relu_7 = self.lrelu(bn_7, name='relu_7')
            ...
            bn_8 = self.layerbn(inputdata=dia_conv2, is_training=self._is_training,
                                name='bn_8')
            relu_8 = self.lrelu(bn_8, name='relu_8')
            ...
            bn_9 = self.layerbn(inputdata=dia_conv3, is_training=self._is_training,
                                name='bn_9')
            relu_9 = self.lrelu(bn_9, name='relu_9')
            ...
            bn_10 = self.layerbn(inputdata=dia_conv4, is_training=self._is_training,
                                name='bn_10')
            relu_10 = self.lrelu(bn_10, name='relu_10')
            ...
            bn_11 = self.layerbn(inputdata=conv_7, is_training=self._is_training,
                                 name='bn_11')
            relu_11 = self.lrelu(inputdata=bn_11, name='relu_11')
            ...
            bn_12 = self.layerbn(inputdata=conv_8, is_training=self._is_training,
                                 name='bn_12')
            relu_12 = self.lrelu(inputdata=bn_12, name='relu_12')
            ...
            bn_14 = self.layerbn(inputdata=conv_9, is_training=self._is_training,
                                 name='bn_14')
            relu_14 = self.lrelu(inputdata=bn_14, name='relu_14')
            ...
            bn_16 = self.layerbn(inputdata=conv_10, is_training=self._is_training,
                                 name='bn_16')
            relu_16 = self.lrelu(inputdata=bn_16, name='relu_16')
